package
{
	...
	public class MainWorker extends Sprite
	{
		...
		private function childrenToMainChannelMessage ( eve : Event ) : void
		{
			...
			var str : String = childrenToMainChannel.receive() as String;
			
			if ( str == "发送一条消息回应子线程已经完全开启！" )
			{
				//// 停止延迟检测机制
			...
			{
				childrenToMainTF.appendText( str + "\n" );
			}
		}
		...
		{
			var str1 : String = "这是一段主线程发送给子线程的消息1";
			var str2 : String = "这是一段主线程发送给子线程的消息2";
			var str3 : String = "这是一段主线程发送给子线程的消息3";
			var str4 : String = "这是一段主线程发送给子线程的消息4";
			
			mainToChildrenChannel.send( str1 );
			mainToChildrenChannel.send( str2 );
			mainToChildrenChannel.send( str3 );
			mainToChildrenChannel.send( str4 );
		
			mainToChildrenTF.appendText( str1 + "\n" );
			mainToChildrenTF.appendText( str2 + "\n" );
			mainToChildrenTF.appendText( str3 + "\n" );
			mainToChildrenTF.appendText( str4 + "\n" );
		}
