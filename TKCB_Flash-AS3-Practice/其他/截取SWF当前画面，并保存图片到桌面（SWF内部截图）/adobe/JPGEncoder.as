package adobe
{
	...
	/**
	 * JPGEncoder 类是JPG图片的编码器，用于对BitmapData对象进行JPG编码，可用于保存JPG图片等。
	...
	public class JPGEncoder
	{
		...
		/**
		 * 构造函数，初始化JPGEncoder对象，并设置编码质量（级别）。
		 * @param 图片的编码质量（级别）。1-100之间的数字，默认为50。
		 * @langversion ActionScript 3.0
		 */
		...
		/**
		 * 对BitmapData对象进行JPG编码。
		 * @param image 将被转换成JPEG格式图像的BitmapData对象。
		 * @return ByteArray代表JPEG编码的图像数据。
		 * @langversion ActionScript 3.0
		 */
