package com.dusk.zipcore.struct {
    ...
    public class ZipEndRecord {
        ...
        private var _sizeCentralDir:Number;
        private var _offsetCentralDir:Number;
        ...
        public function write(data:IDataOutput, fileNum:int, offset:Number, centralDirSize:int):void {
        ...
        public function read(data:IDataInput):void {
            ...
            bytes.position = 16;
            _offsetCentralDir = bytes.readUnsignedInt();
            bytes.position = 20;
        ...
        public function dumpLogInfo():void {
            ZipLog.debug("*************** END OF RECORD DIRECTORY RECORD **************** " + _signature.toString(16));
            ZipLog.debug("number of this disk : " + _numberDisk);
            ZipLog.debug("Number of the disk with the start of the central directory : " + _numberDiskStartCentralDir);
            ZipLog.debug("Total number of entries in the central dir on this disk : " + _totalEntriesDisk);
            ZipLog.debug("Total number of entries in the central dir : " + _totalEntries);
            ZipLog.debug("Size of the central directory : " + _sizeCentralDir);
            ZipLog.debug("Offset of start of central directory with respect to the starting disk numbe : " + _offsetCentralDir);
            ZipLog.debug("zipfile comment length : " + _commentLength);
        }
    }
