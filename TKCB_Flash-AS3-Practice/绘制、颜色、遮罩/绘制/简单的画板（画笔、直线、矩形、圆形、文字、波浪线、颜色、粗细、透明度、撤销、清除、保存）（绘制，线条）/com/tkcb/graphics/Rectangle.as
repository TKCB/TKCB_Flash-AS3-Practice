...
package com.tkcb.graphics
{
	 ...
	 * 矩形类，用于绘制矩形
	 */
	public class Rectangle extends GraphicFill
	{
		//************************ ************************* 属　　性 ******************** *********** *** **////
		...
		private function stageMouse ( eve : MouseEvent ) : void
		{
			switch ( eve.type )
			{
				...
				case MouseEvent.MOUSE_MOVE:
					...
					if ( isLine ) currentShape.graphics.lineStyle( lineSize, lineColor, lineAlpha );
					if ( isFill ) currentShape.graphics.beginFill( fillColor, fillAlpha );
					currentShape.graphics.moveTo( currentX, currentY );
					currentShape.graphics.drawRect( currentX, currentY, eve.stageX - currentX, eve.stageY - currentY );
					break;
