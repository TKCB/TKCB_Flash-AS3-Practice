	...
	public class Color
	{
		...
		public static function getColorListView(): Sprite
		{
			...
			for (var i: int = 0; i < xmlList.length(); i++)
			{
				arr.push(
				{
					name: xmlList[i].@name.toString(),
					color: Color[xmlList[i].@name],
					red: Color[xmlList[i].@name] >> 16,
					green: Color[xmlList[i].@name] >> 8 & 0xff,
					blue: Color[xmlList[i].@name] & 0xFF
				});
			}
