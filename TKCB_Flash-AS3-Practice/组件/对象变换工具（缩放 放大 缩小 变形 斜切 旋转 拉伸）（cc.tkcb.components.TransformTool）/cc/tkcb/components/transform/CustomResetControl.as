package cc.tkcb.components.transform
{
	...
	import cc.tkcb.display.transform.TransformTool;
	import cc.tkcb.display.transform.TransformToolControl;
	import cc.tkcb.display.transform.TransformToolCursor;
